...
public class frame extends JFrame {
    ...
    private void jbInit() throws Exception {
        ...
        jScrollPane2.setBounds(new Rectangle(395, 65, 365, 300));
        jScrollPane2.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        jTextPane2.setBounds(new Rectangle(20, 40, 40, 20));
        jTextPane2.setVisible(false);
        JFileChooser1.setLocation(300, 200);
        //        JFileChooser1.setCurrentDirectory(new File("C:\\"));--глючит
    ...
    if (jButton1.getText() != "Молитва...") {
        ...
        try {
            ...
            s = db2.analyzer_main(decodedString, dt_analiza);
...
//
      ...
      //  jTextPane1.setText(this.textMolA);
        
        
      JFrame frame1 = new frame4();
